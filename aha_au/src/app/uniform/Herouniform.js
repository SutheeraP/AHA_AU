  ...
  return (
    <div>
      <div className="h-screen flex justify-center relative">
        ...
        <div className="bg-gradient-to-b from-zinc-900/10 to-secondary-400  w-full h-full absolute z-0"></div>
        <div className="w-full h-full absolute z-0 flex">
            <div className="mx-auto w-1/2 relative">
                <div className="border border-faded ml-4 w-36 md:w-72 aspect-square right-0 top-[40%] md:top-1/4 rounded-full absolute z-0"></div>
            </div>
        </div>
        <div className="w-full h-full absolute z-0 flex">
