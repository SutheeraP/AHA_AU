...
export default function Home() {
  return (
    <main className="bg-secondary-400 text-white w-screen overflow-hidden relative">
      ...
      <div className={kanit.className}>
        <div className="container mx-auto px-4 lg:px-60 text-sm pt-32 text-center font-light">
          <div className="py-12">
            ในปี 2099 โลกมนุษย์ได้มีการพัฒนาของเทคโนโลยีสู่จุดสูงสุด
          ...
          <div className="py-12">
            ...
            ที่พร้อมจะเข้าร่วมอุดมการณ์ในการปกป้องประชาชนให้ปลอดภัย …
            ไม่ว่าจะเป็นเผ่าไหน หรือตัวอะไรก็ตาม
